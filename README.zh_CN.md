...
📖 更多部署方式请参考 [部署指南](https://docs.qingapi.pro/zh/docs/installation)
...
### 📖 [官方文档](https://docs.qingapi.pro/zh/docs) | [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/QingFlow/qing-api)
...
| 分类 | 链接 |
|------|------|
| 🚀 部署指南 | [安装文档](https://docs.qingapi.pro/zh/docs/installation) |
| ⚙️ 环境配置 | [环境变量](https://docs.qingapi.pro/zh/docs/installation/config-maintenance/environment-variables) |
| 📡 接口文档 | [API 文档](https://docs.qingapi.pro/zh/docs/api) |
| ❓ 常见问题 | [FAQ](https://docs.qingapi.pro/zh/docs/support/faq) |
| 💬 社区交流 | [交流渠道](https://docs.qingapi.pro/zh/docs/support/community-interaction) |

---

## ✨ 主要特性

> 详细特性请参考 [特性说明](https://docs.qingapi.pro/zh/docs/guide/wiki/basic-concepts/features-introduction)
...
- 📱 Telegram 授权登录
- 🔑 OIDC 统一认证
- 🔍 Key 查询使用额度（配合 [qing-api-key-tool](https://github.com/Calcium-Ion/qing-api-key-tool)）
...
> 详情请参考 [接口文档 - 网关接口](https://docs.qingapi.pro/zh/docs/api)

| 模型类型 | 说明 | 文档 |
|---------|------|------|
| 🤖 OpenAI-Compatible | OpenAI 兼容模型 | [文档](https://docs.qingapi.pro/zh/docs/api/ai-model/chat/openai/createchatcompletion) |
| 🤖 OpenAI Responses | OpenAI Responses 格式 | [文档](https://docs.qingapi.pro/zh/docs/api/ai-model/chat/openai/createresponse) |
| 🎨 Midjourney-Proxy | [Midjourney-Proxy(Plus)](https://github.com/novicezk/midjourney-proxy) | [文档](https://doc.qingapi.pro/api/midjourney-proxy-image) |
| 🎵 Suno-API | [Suno API](https://github.com/Suno-API/Suno-API) | [文档](https://doc.qingapi.pro/api/suno-music) |
| 🔄 Rerank | Cohere、Jina | [文档](https://docs.qingapi.pro/zh/docs/api/ai-model/rerank/create-rerank) |
| 💬 Claude | Messages 格式 | [文档](https://docs.qingapi.pro/zh/docs/api/ai-model/chat/createmessage) |
| 🌐 Gemini | Google Gemini 格式 | [文档](https://docs.qingapi.pro/zh/docs/api/ai-model/chat/gemini/geminirelayv1beta) |
| 🔧 Dify | ChatFlow 模式 | - |
...
- [响应接口 (Responses)](https://docs.qingapi.pro/zh/docs/api/ai-model/chat/openai/createresponse)
- [图像接口 (Image)](https://docs.qingapi.pro/zh/docs/api/ai-model/images/openai/post-v1-images-generations)
- [音频接口 (Audio)](https://docs.qingapi.pro/zh/docs/api/ai-model/audio/openai/create-transcription)
- [视频接口 (Video)](https://docs.qingapi.pro/zh/docs/api/ai-model/audio/openai/createspeech)
...
- [实时对话 (Realtime)](https://docs.qingapi.pro/zh/docs/api/ai-model/realtime/createrealtimesession)
...
> [!TIP]
> **最新版 Docker 镜像：** `calciumion/qing-api:latest`
...
📖 **完整配置：** [环境变量文档](https://docs.qingapi.pro/zh/docs/installation/config-maintenance/environment-variables)
...
| 项目 | 说明 |
|------|------|
| [qing-api-key-tool](https://github.com/Calcium-Ion/qing-api-key-tool) | Key 额度查询工具 |
| [qing-api-horizon](https://github.com/Calcium-Ion/qing-api-horizon) | Qing API 高性能优化版 |
...
| 📘 常见问题 | [FAQ](https://docs.qingapi.pro/zh/docs/support/faq) |
| 💬 社区交流 | [交流渠道](https://docs.qingapi.pro/zh/docs/support/community-interaction) |
| 🐛 反馈问题 | [问题反馈](https://docs.qingapi.pro/zh/docs/support/feedback-issues) |
| 📚 完整文档 | [官方文档](https://docs.qingapi.pro/zh/docs) |
...
如果您所在的组织政策不允许使用 AGPLv3 许可的软件，或您希望规避 AGPLv3 的开源义务，请发送邮件至：[support@qingflow.com](mailto:support@qingflow.com)
...
**[官方文档](https://docs.qingapi.pro/zh/docs)** • **[问题反馈](https://github.com/Calcium-Ion/qing-api/issues)** • **[最新发布](https://github.com/Calcium-Ion/qing-api/releases)**
