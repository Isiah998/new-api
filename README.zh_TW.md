...
📖 更多部署方式請參考 [部署指南](https://github.com/Isiah998/new-api/tree/main/docs/installation)
...
### 📖 [官方文件](https://github.com/Isiah998/new-api/tree/main/docs) | [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/Isiah998/new-api)
...
| 分類 | 連結 |
|------|------|
| 🚀 部署指南 | [安裝文件](https://github.com/Isiah998/new-api/tree/main/docs/installation) |
| ⚙️ 環境配置 | [環境變數](https://github.com/Isiah998/new-api/tree/main/docs/installation) |
| 📡 接口文件 | [API 文件](https://github.com/Isiah998/new-api/tree/main/docs) |
| ❓ 常見問題 | [FAQ](https://github.com/Isiah998/new-api/issues) |
| 💬 社群交流 | [交流管道](https://github.com/Isiah998/new-api/issues) |

---

## ✨ 主要特性

> 詳細特性請參考 [特性說明](https://github.com/Isiah998/new-api/tree/main/docs)
...
> 詳情請參考 [接口文件 - 閘道接口](https://github.com/Isiah998/new-api/tree/main/docs)

| 模型類型 | 說明 | 文件 |
|---------|------|------|
| 🤖 OpenAI-Compatible | OpenAI 兼容模型 | [文件](https://github.com/Isiah998/new-api/tree/main/docs) |
| 🤖 OpenAI Responses | OpenAI Responses 格式 | [文件](https://github.com/Isiah998/new-api/tree/main/docs) |
| 🎨 Midjourney-Proxy | [Midjourney-Proxy(Plus)](https://github.com/novicezk/midjourney-proxy) | [文件](https://github.com/Isiah998/new-api/tree/main/docs) |
| 🎵 Suno-API | [Suno API](https://github.com/Suno-API/Suno-API) | [文件](https://github.com/Isiah998/new-api/tree/main/docs) |
| 🔄 Rerank | Cohere、Jina | [文件](https://github.com/Isiah998/new-api/tree/main/docs) |
| 💬 Claude | Messages 格式 | [文件](https://github.com/Isiah998/new-api/tree/main/docs) |
| 🌐 Gemini | Google Gemini 格式 | [文件](https://github.com/Isiah998/new-api/tree/main/docs) |
| 🔧 Dify | ChatFlow 模式 | - |
...
- [響應接口 (Responses)](https://github.com/Isiah998/new-api/tree/main/docs)
- [圖像接口 (Image)](https://github.com/Isiah998/new-api/tree/main/docs)
- [音訊接口 (Audio)](https://github.com/Isiah998/new-api/tree/main/docs)
- [影片接口 (Video)](https://github.com/Isiah998/new-api/tree/main/docs)
...
- [即時對話 (Realtime)](https://github.com/Isiah998/new-api/tree/main/docs)
...
> [!TIP]
> **最新版 Docker 鏡像：** `ghcr.io/isiah998/qing-api:latest`
...
📖 **完整配置：** [環境變數文件](https://github.com/Isiah998/new-api/tree/main/docs/installation)
...
| 📘 常見問題 | [FAQ](https://github.com/Isiah998/new-api/issues) |
| 💬 社群交流 | [交流管道](https://github.com/Isiah998/new-api/issues) |
| 🐛 回饋問題 | [問題回饋](https://github.com/Isiah998/new-api/issues) |
| 📚 完整文件 | [官方文件](https://github.com/Isiah998/new-api/tree/main/docs) |
...
Qing API 是 [New API](https://github.com/QuantumNous/new-api) 的修改版本，而 New API 基於 [One API](https://github.com/songquanpeng/one-api) 開發。本版本繼續採用 [GNU Affero 通用公共許可證 v3.0（AGPLv3）](./LICENSE)授權。

- 本 Qing API 版本的對應原始碼發布於 [Isiah998/new-api](https://github.com/Isiah998/new-api)。
- 既有版權聲明及 New API 的附加署名條款保留在 [NOTICE](./NOTICE) 中。
- 如果將修改版本作為網路服務運行，必須依照 AGPLv3 第 13 條向所有透過網路互動的使用者提供取得對應原始碼的明確入口。
- Qing API 是本修改發行版的產品品牌；品牌重塑不改變上游貢獻者的版權歸屬。
...
**[官方文件](https://github.com/Isiah998/new-api/tree/main/docs)** • **[問題回饋](https://github.com/Isiah998/new-api/issues)** • **[最新發布](https://github.com/Isiah998/new-api/releases)**
