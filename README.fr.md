...
<p align="center">
  <a href="https://raw.githubusercontent.com/Calcium-Ion/qing-api/main/LICENSE">
    <img src="https://img.shields.io/github/license/Calcium-Ion/qing-api?color=brightgreen" alt="licence">
  </a><!--
  --><a href="https://github.com/Calcium-Ion/qing-api/releases/latest">
    <img src="https://img.shields.io/github/v/release/Calcium-Ion/qing-api?color=brightgreen&include_prereleases" alt="version">
  </a><!--
...
📖 Pour plus de méthodes de déploiement, veuillez vous référer à [Guide de déploiement](https://docs.qingapi.pro/en/docs/installation)
...
### 📖 [Documentation officielle](https://docs.qingapi.pro/en/docs) | [![Demander à DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/QingFlow/qing-api)
...
| Catégorie | Lien |
|------|------|
| 🚀 Guide de déploiement | [Documentation d'installation](https://docs.qingapi.pro/en/docs/installation) |
| ⚙️ Configuration de l'environnement | [Variables d'environnement](https://docs.qingapi.pro/en/docs/installation/config-maintenance/environment-variables) |
| 📡 Documentation de l'API | [Documentation de l'API](https://docs.qingapi.pro/en/docs/api) |
| ❓ FAQ | [FAQ](https://docs.qingapi.pro/en/docs/support/faq) |
| 💬 Interaction avec la communauté | [Canaux de communication](https://docs.qingapi.pro/en/docs/support/community-interaction) |

---

## ✨ Fonctionnalités clés

> Pour les fonctionnalités détaillées, veuillez vous référer à [Présentation des fonctionnalités](https://docs.qingapi.pro/en/docs/guide/wiki/basic-concepts/features-introduction) |
...
- 🔍 Requête de quota d'utilisation de clé (avec [qing-api-key-tool](https://github.com/Calcium-Ion/qing-api-key-tool))

### 🚀 Fonctionnalités avancées

**Prise en charge des formats d'API:**
- ⚡ [OpenAI Responses](https://docs.qingapi.pro/en/docs/api/ai-model/chat/openai/create-response)
- ⚡ [OpenAI Realtime API](https://docs.qingapi.pro/en/docs/api/ai-model/realtime/create-realtime-session) (y compris Azure)
- ⚡ [Claude Messages](https://docs.qingapi.pro/en/docs/api/ai-model/chat/create-message)
- ⚡ [Google Gemini](https://doc.qingapi.pro/en/api/google-gemini-chat)
- 🔄 [Modèles Rerank](https://docs.qingapi.pro/en/docs/api/ai-model/rerank/create-rerank) (Cohere, Jina)
...
> Pour les détails, veuillez vous référer à [Documentation de l'API - Interface de passerelle](https://docs.qingapi.pro/en/docs/api)

| Type de modèle | Description | Documentation |
|---------|------|------|
| 🤖 OpenAI-Compatible | Modèles compatibles OpenAI | [Documentation](https://docs.qingapi.pro/en/docs/api/ai-model/chat/openai/createchatcompletion) |
| 🤖 OpenAI Responses | Format OpenAI Responses | [Documentation](https://docs.qingapi.pro/en/docs/api/ai-model/chat/openai/createresponse) |
| 🎨 Midjourney-Proxy | [Midjourney-Proxy(Plus)](https://github.com/novicezk/midjourney-proxy) | [Documentation](https://doc.qingapi.pro/api/midjourney-proxy-image) |
| 🎵 Suno-API | [Suno API](https://github.com/Suno-API/Suno-API) | [Documentation](https://doc.qingapi.pro/api/suno-music) |
| 🔄 Rerank | Cohere, Jina | [Documentation](https://docs.qingapi.pro/en/docs/api/ai-model/rerank/creatererank) |
| 💬 Claude | Format Messages | [Documentation](https://docs.qingapi.pro/en/docs/api/ai-model/chat/createmessage) |
| 🌐 Gemini | Format Google Gemini | [Documentation](https://docs.qingapi.pro/en/docs/api/ai-model/chat/gemini/geminirelayv1beta) |
| 🔧 Dify | Mode ChatFlow | - |
...
- [Interface de discussion (Chat Completions)](https://docs.qingapi.pro/en/docs/api/ai-model/chat/openai/createchatcompletion)
- [Interface de réponse (Responses)](https://docs.qingapi.pro/en/docs/api/ai-model/chat/openai/createresponse)
- [Interface d'image (Image)](https://docs.qingapi.pro/en/docs/api/ai-model/images/openai/post-v1-images-generations)
- [Interface audio (Audio)](https://docs.qingapi.pro/en/docs/api/ai-model/audio/openai/create-transcription)
- [Interface vidéo (Video)](https://docs.qingapi.pro/en/docs/api/ai-model/audio/openai/createspeech)
- [Interface d'incorporation (Embeddings)](https://docs.qingapi.pro/en/docs/api/ai-model/embeddings/createembedding)
- [Interface de rerank (Rerank)](https://docs.qingapi.pro/en/docs/api/ai-model/rerank/creatererank)
- [Conversation en temps réel (Realtime)](https://docs.qingapi.pro/en/docs/api/ai-model/realtime/createrealtimesession)
- [Discussion Claude](https://docs.qingapi.pro/en/docs/api/ai-model/chat/createmessage)
- [Discussion Google Gemini](https://docs.qingapi.pro/en/docs/api/ai-model/chat/gemini/geminirelayv1beta)
...
> [!TIP]
> **Dernière image Docker:** `calciumion/qing-api:latest`
...
📖 **Configuration complète:** [Documentation des variables d'environnement](https://docs.qingapi.pro/en/docs/installation/config-maintenance/environment-variables)
...
| Projet | Description |
|------|------|
| [qing-api-key-tool](https://github.com/Calcium-Ion/qing-api-key-tool) | Outil de recherche de quota d'utilisation avec une clé |
| [qing-api-horizon](https://github.com/Calcium-Ion/qing-api-horizon) | Version optimisée haute performance de Qing API |
...
| 📘 FAQ | [FAQ](https://docs.qingapi.pro/en/docs/support/faq) |
| 💬 Interaction avec la communauté | [Canaux de communication](https://docs.qingapi.pro/en/docs/support/community-interaction) |
| 🐛 Commentaires sur les problèmes | [Commentaires sur les problèmes](https://docs.qingapi.pro/en/docs/support/feedback-issues) |
| 📚 Documentation complète | [Documentation officielle](https://docs.qingapi.pro/en/docs) |
...
Si les politiques de votre organisation ne permettent pas l'utilisation de logiciels sous licence AGPLv3, ou si vous souhaitez éviter les obligations open-source de l'AGPLv3, veuillez nous contacter à : [support@qingflow.com](mailto:support@qingflow.com)
...
[![Graphique de l'historique des étoiles](https://api.star-history.com/svg?repos=Calcium-Ion/qing-api&type=Date)](https://star-history.com/#Calcium-Ion/qing-api&Date)
...
**[Documentation officielle](https://docs.qingapi.pro/en/docs)** • **[Commentaires sur les problèmes](https://github.com/Calcium-Ion/qing-api/issues)** • **[Dernière version](https://github.com/Calcium-Ion/qing-api/releases)**
