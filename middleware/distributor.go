...
func SetupContextForSelectedChannel(c *gin.Context, channel *model.Channel, modelName string) *types.QingAPIError {
	...
	key, index, qingAPIError := channel.GetNextEnabledKey()
	if qingAPIError != nil {
		return qingAPIError
	}
