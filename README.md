...
📖 For more deployment methods, please refer to [Deployment Guide](https://docs.qingapi.pro/en/docs/installation)
...
### 📖 [Official Documentation](https://docs.qingapi.pro/en/docs) | [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/QingFlow/qing-api)
...
| Category | Link |
|------|------|
| 🚀 Deployment Guide | [Installation Documentation](https://docs.qingapi.pro/en/docs/installation) |
| ⚙️ Environment Configuration | [Environment Variables](https://docs.qingapi.pro/en/docs/installation/config-maintenance/environment-variables) |
| 📡 API Documentation | [API Documentation](https://docs.qingapi.pro/en/docs/api) |
| ❓ FAQ | [FAQ](https://docs.qingapi.pro/en/docs/support/faq) |
| 💬 Community Interaction | [Communication Channels](https://docs.qingapi.pro/en/docs/support/community-interaction) |

---

## ✨ Key Features

> For detailed features, please refer to [Features Introduction](https://docs.qingapi.pro/en/docs/guide/wiki/basic-concepts/features-introduction)
...
- 🔍 Key quota query usage (with [qing-api-key-tool](https://github.com/Calcium-Ion/qing-api-key-tool))

### 🚀 Advanced Features

**API Format Support:**
- ⚡ [OpenAI Responses](https://docs.qingapi.pro/en/docs/api/ai-model/chat/openai/create-response)
- ⚡ [OpenAI Realtime API](https://docs.qingapi.pro/en/docs/api/ai-model/realtime/create-realtime-session) (including Azure)
...
- 🔄 [Rerank Models](https://docs.qingapi.pro/en/docs/api/ai-model/rerank/create-rerank) (Cohere, Jina)
...
> For details, please refer to [API Documentation - Gateway Interface](https://docs.qingapi.pro/en/docs/api)

| Model Type | Description | Documentation |
|---------|------|------|
| 🤖 OpenAI-Compatible | OpenAI compatible models | [Documentation](https://docs.qingapi.pro/en/docs/api/ai-model/chat/openai/createchatcompletion) |
| 🤖 OpenAI Responses | OpenAI Responses format | [Documentation](https://docs.qingapi.pro/en/docs/api/ai-model/chat/openai/createresponse) |
...
| 💬 Claude | Messages format | [Documentation](https://docs.qingapi.pro/en/docs/api/ai-model/chat/createmessage) |
| 🌐 Gemini | Google Gemini format | [Documentation](https://docs.qingapi.pro/en/docs/api/ai-model/chat/gemini/geminirelayv1beta) |
| 🔧 Dify | ChatFlow mode | - |
...
- [Chat Interface (Chat Completions)](https://docs.qingapi.pro/en/docs/api/ai-model/chat/openai/createchatcompletion)
- [Response Interface (Responses)](https://docs.qingapi.pro/en/docs/api/ai-model/chat/openai/createresponse)
- [Image Interface (Image)](https://docs.qingapi.pro/en/docs/api/ai-model/images/openai/post-v1-images-generations)
- [Audio Interface (Audio)](https://docs.qingapi.pro/en/docs/api/ai-model/audio/openai/create-transcription)
- [Video Interface (Video)](https://docs.qingapi.pro/en/docs/api/ai-model/audio/openai/createspeech)
- [Embedding Interface (Embeddings)](https://docs.qingapi.pro/en/docs/api/ai-model/embeddings/createembedding)
- [Rerank Interface (Rerank)](https://docs.qingapi.pro/en/docs/api/ai-model/rerank/creatererank)
- [Realtime Conversation (Realtime)](https://docs.qingapi.pro/en/docs/api/ai-model/realtime/createrealtimesession)
- [Claude Chat](https://docs.qingapi.pro/en/docs/api/ai-model/chat/createmessage)
- [Google Gemini Chat](https://docs.qingapi.pro/en/docs/api/ai-model/chat/gemini/geminirelayv1beta)
...
📖 **Complete configuration:** [Environment Variables Documentation](https://docs.qingapi.pro/en/docs/installation/config-maintenance/environment-variables)
...
| 📘 FAQ | [FAQ](https://docs.qingapi.pro/en/docs/support/faq) |
| 💬 Community Interaction | [Communication Channels](https://docs.qingapi.pro/en/docs/support/community-interaction) |
| 🐛 Issue Feedback | [Issue Feedback](https://docs.qingapi.pro/en/docs/support/feedback-issues) |
| 📚 Complete Documentation | [Official Documentation](https://docs.qingapi.pro/en/docs) |
...
the author attribution notice `Frontend design and development by Qing API
...
link to the original project: <https://github.com/QingFlow/qing-api>.

This is an open-source project developed based on [One API](https://github.com/songquanpeng/one-api) (MIT License).

If your organization's policies do not permit the use of AGPLv3-licensed software, or if you wish to avoid the open-source obligations of AGPLv3, please contact us at: [support@qingflow.com](mailto:support@qingflow.com)
...
**[Official Documentation](https://docs.qingapi.pro/en/docs)** • **[Issue Feedback](https://github.com/Calcium-Ion/qing-api/issues)** • **[Latest Release](https://github.com/Calcium-Ion/qing-api/releases)**
