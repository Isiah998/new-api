...
func ClaudeHelper(c *gin.Context, info *relaycommon.RelayInfo) (qingAPIError *types.QingAPIError) {
	...
	if !model_setting.GetGlobalSettings().PassThroughRequestEnabled &&
		...
		usage, qingApiErr := chatCompletionsViaResponses(c, info, adaptor, openAIRequest)
		if qingApiErr != nil {
			return qingApiErr
		}
