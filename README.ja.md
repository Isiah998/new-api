...
📖 その他のデプロイ方法については[デプロイガイド](https://docs.qingapi.pro/ja/docs/installation)を参照してください。
...
### 📖 [公式ドキュメント](https://docs.qingapi.pro/ja/docs) | [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/QingFlow/qing-api)
...
| カテゴリ | リンク |
|------|------|
| 🚀 デプロイガイド | [インストールドキュメント](https://docs.qingapi.pro/ja/docs/installation) |
| ⚙️ 環境設定 | [環境変数](https://docs.qingapi.pro/ja/docs/installation/config-maintenance/environment-variables) |
| 📡 APIドキュメント | [APIドキュメント](https://docs.qingapi.pro/ja/docs/api) |
| ❓ よくある質問 | [FAQ](https://docs.qingapi.pro/ja/docs/support/faq) |
| 💬 コミュニティ交流 | [交流チャネル](https://docs.qingapi.pro/ja/docs/support/community-interaction) |

---

## ✨ 主な機能

> 詳細な機能については[機能説明](https://docs.qingapi.pro/ja/docs/guide/wiki/basic-concepts/features-introduction)を参照してください。
...
**APIフォーマットサポート:**
- ⚡ [OpenAI Responses](https://docs.qingapi.pro/ja/docs/api/ai-model/chat/openai/create-response)
- ⚡ [OpenAI Realtime API](https://docs.qingapi.pro/ja/docs/api/ai-model/realtime/create-realtime-session)（Azureを含む）
- ⚡ [Claude Messages](https://docs.qingapi.pro/ja/docs/api/ai-model/chat/create-message)
- ⚡ [Google Gemini](https://doc.qingapi.pro/ja/api/google-gemini-chat)
- 🔄 [Rerankモデル](https://docs.qingapi.pro/ja/docs/api/ai-model/rerank/create-rerank)（Cohere、Jina）
...
> 詳細については[APIドキュメント - ゲートウェイインターフェース](https://docs.qingapi.pro/ja/docs/api)

| モデルタイプ | 説明 | ドキュメント |
|---------|------|------|
| 🤖 OpenAI-Compatible | OpenAI互換モデル | [ドキュメント](https://docs.qingapi.pro/ja/docs/api/ai-model/chat/openai/createchatcompletion) |
| 🤖 OpenAI Responses | OpenAI Responsesフォーマット | [ドキュメント](https://docs.qingapi.pro/ja/docs/api/ai-model/chat/openai/createresponse) |
...
| 🔄 Rerank | Cohere、Jina | [ドキュメント](https://docs.qingapi.pro/ja/docs/api/ai-model/rerank/creatererank) |
| 💬 Claude | Messagesフォーマット | [ドキュメント](https://docs.qingapi.pro/ja/docs/api/ai-model/chat/createmessage) |
| 🌐 Gemini | Google Geminiフォーマット | [ドキュメント](https://docs.qingapi.pro/ja/docs/api/ai-model/chat/gemini/geminirelayv1beta) |
| 🔧 Dify | ChatFlowモード | - |
...
- [チャットインターフェース (Chat Completions)](https://docs.qingapi.pro/ja/docs/api/ai-model/chat/openai/createchatcompletion)
- [レスポンスインターフェース (Responses)](https://docs.qingapi.pro/ja/docs/api/ai-model/chat/openai/createresponse)
- [イメージインターフェース (Image)](https://docs.qingapi.pro/ja/docs/api/ai-model/images/openai/post-v1-images-generations)
- [オーディオインターフェース (Audio)](https://docs.qingapi.pro/ja/docs/api/ai-model/audio/openai/create-transcription)
- [ビデオインターフェース (Video)](https://docs.qingapi.pro/ja/docs/api/ai-model/audio/openai/createspeech)
- [エンベッドインターフェース (Embeddings)](https://docs.qingapi.pro/ja/docs/api/ai-model/embeddings/createembedding)
- [再ランク付けインターフェース (Rerank)](https://docs.qingapi.pro/ja/docs/api/ai-model/rerank/creatererank)
- [リアルタイム対話インターフェース (Realtime)](https://docs.qingapi.pro/ja/docs/api/ai-model/realtime/createrealtimesession)
- [Claudeチャット](https://docs.qingapi.pro/ja/docs/api/ai-model/chat/createmessage)
- [Google Geminiチャット](https://docs.qingapi.pro/ja/docs/api/ai-model/chat/gemini/geminirelayv1beta)
...
📖 **完全な設定:** [環境変数ドキュメント](https://docs.qingapi.pro/ja/docs/installation/config-maintenance/environment-variables)
...
| 📘 よくある質問 | [FAQ](https://docs.qingapi.pro/ja/docs/support/faq) |
| 💬 コミュニティ交流 | [交流チャネル](https://docs.qingapi.pro/ja/docs/support/community-interaction) |
| 🐛 問題のフィードバック | [問題フィードバック](https://docs.qingapi.pro/ja/docs/support/feedback-issues) |
| 📚 完全なドキュメント | [公式ドキュメント](https://docs.qingapi.pro/ja/docs) |
...
**[公式ドキュメント](https://docs.qingapi.pro/ja/docs)** • **[問題フィードバック](https://github.com/Calcium-Ion/qing-api/issues)** • **[最新リリース](https://github.com/Calcium-Ion/qing-api/releases)**
